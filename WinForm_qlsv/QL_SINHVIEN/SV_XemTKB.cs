...
namespace Login
{
    ...
    public partial class SV_XemTKB : Form
    {
        public SV_XemTKB()
        {
            InitializeComponent();
        ...
        public void LoadMain()
        {
            ...
            cob_hocky.SelectedIndex = 0;
            cob_tuan.SelectedIndex = 5;
        }
        private void Xem_TKB_Load(object sender, EventArgs e)
        {

            LoadMain();

            dgv_schedule.DataSource = Load_TKB();

            // handle hover change color text
        ...
        private DataTable Load_TKB()
        {
            DataTable dt = new DataTable();
            try
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("PrintSchedule", conn);
